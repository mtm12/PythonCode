...
ckey = 'YrNFpYqKyNNSWUvmLI2aUc2nr'
csecret = 'QCGsGuk2eM9O0WNOQ5URB1tFigWV4pt7TUPKuR7HRkHv3W5lG3'
atoken = '384070998-Gx2Lhq7RodIVnsCId044iwury9Auyl6VNJH8ijBi'
asecret = 'DqfDux1Q75aPk2QktILRiJmUbnem0bEOsCmpcCYRte5QZ'
...
class listener(StreamListener):
	...
	def on_data(self, data):
		...
		try:
                  ...
                  command = ("INSERT INTO `fb` (`score`) VALUES (" + str(score) + ")")
...
try:
        ...
        twitterStream.filter(track=["fb", "facebook"])
        #ply.show()
