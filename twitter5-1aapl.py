...
ckey = 'KRQL2E0DYe09GWJDdIciANA0v'
csecret = 'zJiSH9Qd8TTdaijtzKPCjDV2JdwdLBiUZsPp8oeyQxmWnzGopO'
atoken = '384070998-XvB5QyaAh64ByvwJtuGu4L5w3K3OtXHXXeUQozAS'
asecret = '0uKyGFrisvpvILgwJcbHbFunvrrXg7kroH7cegQjNPxOQ'
...
class listener(StreamListener):
	...
	def on_data(self, data):
		...
		try:
                  ...
                  command = ("INSERT INTO `aapl` (`score`) VALUES (" + str(score) + ")")
