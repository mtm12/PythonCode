...
ckey = 'OtbaU8kCGJpSQN1nw7sgDcnvX'
csecret = '8uWWwiRIU3QpoC4bbILxsMXGWXOJPkM4pR4D58TFXuaEybpgOV'
atoken = '384070998-jafYaCNDLjtZAOoLvxxaMiltCWvjXU0tBaCDMBf3'
asecret = 'OSEUT9amz2XgXGept9fWGoYDpc1A6mfJ3CGQiHCfpcvTt'
...
class listener(StreamListener):
	...
	def on_data(self, data):
		...
		try:
                  ...
                  command = ("INSERT INTO `brexit` (`score`) VALUES (" + str(score) + ")")
